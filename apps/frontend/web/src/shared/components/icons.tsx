 ...
 *
 * It shipped as a single path filled #EA4335 — the whole glyph in red, which
 * reads as a smudge next to the word "Google" and is not a logo Google
 * permits. The four paths below are the official ones: blue, green, yellow,
 * red, in that order. They are separate on purpose; merging them is what
 * produced the broken version.
 */
