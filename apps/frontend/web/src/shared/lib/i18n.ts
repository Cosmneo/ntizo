...
void i18n
  ...
  .init({
    ...
    ns: ["common", "auth", "provider", "admin", "directory", "landing", "account", "notifications", "messaging", "legal", "checkout", "company", "help"],
    defaultNS: "common",
