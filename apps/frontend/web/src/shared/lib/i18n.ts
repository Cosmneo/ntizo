...
const resources = {
  "en-US": {
    ...
    admin: enUSAdmin,
    directory: enUSDirectory,
    landing: enUSLanding,
    account: enUSAccount,
    becomeProvider: enUSBecomeProvider,
    onboarding: enUSOnboarding,
    notifications: enUSNotifications,
    messaging: enUSMessaging,
    legal: enUSLegal,
  ...
  "pt-PT": {
    common: ptPTCommon,
    auth: ptPTAuth,
    provider: ptPTProvider,
    admin: ptPTAdmin,
    directory: ptPTDirectory,
    landing: ptPTLanding,
    account: ptPTAccount,
    becomeProvider: ptPTBecomeProvider,
    onboarding: ptPTOnboarding,
    notifications: ptPTNotifications,
    messaging: ptPTMessaging,
    legal: ptPTLegal,
  ...
  "pt-MZ": {
    common: ptMZCommon,
    auth: ptMZAuth,
    provider: ptMZProvider,
    admin: ptMZAdmin,
    directory: ptMZDirectory,
    landing: ptMZLanding,
    account: ptMZAccount,
    becomeProvider: ptMZBecomeProvider,
    onboarding: ptMZOnboarding,
    notifications: ptMZNotifications,
    messaging: ptMZMessaging,
    legal: ptMZLegal,
  ...
  "es-ES": {
    common: esESCommon,
    auth: esESAuth,
    provider: esESProvider,
    admin: esESAdmin,
    directory: esESDirectory,
    landing: esESLanding,
    account: esESAccount,
    becomeProvider: esESBecomeProvider,
    onboarding: esESOnboarding,
    notifications: esESNotifications,
    messaging: esESMessaging,
    legal: esESLegal,
  ...
  "de-DE": {
    common: deDECommon,
    auth: deDEAuth,
    provider: deDEProvider,
    admin: deDEAdmin,
    directory: deDEDirectory,
    landing: deDELanding,
    account: deDEAccount,
    becomeProvider: deDEBecomeProvider,
    onboarding: deDEOnboarding,
    notifications: deDENotifications,
    messaging: deDEMessaging,
    legal: deDELegal,
  ...
  "fr-FR": {
    common: frFRCommon,
    auth: frFRAuth,
    provider: frFRProvider,
    admin: frFRAdmin,
    directory: frFRDirectory,
    landing: frFRLanding,
    account: frFRAccount,
    becomeProvider: frFRBecomeProvider,
    onboarding: frFROnboarding,
    notifications: frFRNotifications,
    messaging: frFRMessaging,
    legal: frFRLegal,
  ...
  "it-IT": {
    common: itITCommon,
    auth: itITAuth,
    provider: itITProvider,
    admin: itITAdmin,
    directory: itITDirectory,
    landing: itITLanding,
    account: itITAccount,
    becomeProvider: itITBecomeProvider,
    onboarding: itITOnboarding,
    notifications: itITNotifications,
    messaging: itITMessaging,
    legal: itITLegal,
  ...
  "nl-NL": {
    common: nlNLCommon,
    auth: nlNLAuth,
    provider: nlNLProvider,
    admin: nlNLAdmin,
    directory: nlNLDirectory,
    landing: nlNLLanding,
    account: nlNLAccount,
    becomeProvider: nlNLBecomeProvider,
    onboarding: nlNLOnboarding,
    notifications: nlNLNotifications,
    messaging: nlNLMessaging,
    legal: nlNLLegal,
