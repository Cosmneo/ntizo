...
export function RequestQuotePage({ serviceId }: { serviceId: string }) {
  ...
  return (
    <main className="page-shell py-8 lg:py-12">
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_20rem] lg:items-start">
        <form onSubmit={submit} className="order-2 min-w-0 grid gap-6 lg:order-1">
          <div>
        ...
        <aside className="order-1 grid gap-6 lg:order-2 lg:self-start">
